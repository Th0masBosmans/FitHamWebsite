...
export function PlanCard({ plan, index, onRegister }: PlanCardProps) {
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl shadow-xl overflow-hidden relative group h-full"
    >
      <div className="p-6 flex flex-col h-full">
        ...
        <button
          className="mt-auto w-full py-4 rounded-xl font-black uppercase tracking-wider transition-all active:scale-95 bg-[var(--color-accent)] text-[var(--color-primary-brand)] shadow-md shadow-yellow-200/50 hover:bg-[var(--color-accent-border)] hover:shadow-lg hover:-translate-y-0.5 flex items-center justify-center gap-2"
