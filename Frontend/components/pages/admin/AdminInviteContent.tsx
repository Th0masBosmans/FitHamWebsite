...
export function AdminInviteContent() {
  ...
  useEffect(() => {
    // Supabase zet een eventuele fout in de URL, bv. bij een vervallen uitnodiging.
    ...
    // Supabase leest de uitnodigingscode zelf uit de URL; wij wachten gewoon af.
    const {
      data: { subscription },
    ...
    supabase.auth.getSession().then(({ data: { session } }) => {
      if (session) {
        ...
        // Geen geldige code in de URL: er komt dus nooit een sessie. Niet blijven wachten.
        timer = setTimeout(() => {
