...
// De teampagina toont per afdeling een uitklapbaar blok, in deze volgorde.
// Welke afdeling een team heeft, kiest de beheerder bij het team zelf.
...
/** Titelbalk met een plus/min-knopje dat het raster met teamkaartjes open- en dichtklapt. */
...
export function TeamsContent() {
  ...
  // Alleen afdelingen waar echt teams in zitten krijgen een blok.
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-md px-6 pt-6 sm:max-w-2xl lg:max-w-5xl">
        ...
        {/* Twee knoppen onderaan: naar Twizzit (extern) en naar de lidmaatschapspagina */}
