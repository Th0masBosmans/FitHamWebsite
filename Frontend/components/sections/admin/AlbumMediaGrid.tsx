...
/**
 * Wat je ziet als je een album openklapt: alle foto's en filmpjes, met de
 * mogelijkheid om er meerdere aan te duiden en die dan te verwijderen of aan de
 * diavoorstelling van de galerijpagina toe te voegen.
 */
