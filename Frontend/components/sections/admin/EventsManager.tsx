...
type EventsManagerProps = {
  active: boolean;
  /** Gedeeld met het tabblad Foto's, zodat een hier aangemaakt album daar meteen verschijnt. */
  albums: Album[];
  setAlbums: Dispatch<SetStateAction<Album[]>>;
}

/**
 * Tabblad "Evenementen": beheert de clubkalender. Je kan een evenement hier ook
 * aan een fotoalbum koppelen; dan verschijnt op de site een knop naar dat album.
 */
