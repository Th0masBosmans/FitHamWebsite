...
/**
 * Tabblad "Home": beheert de foto's die op vaste plekken van de site staan,
 * zoals de grote banner op de homepagina. De keuzelijst met plekken komt uit
 * data/siteImageSlots.
 */
export function SiteImagesManager({ active }: { active: boolean }) {
  ...
  const handleSave = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // De naam volgt uit de gekozen plek, zodat de beheerder alleen een plek moet
    // kiezen en een foto uploaden.
