...
/**
 * Een albumkaartje in de galerij. De cover vult de hele kaart; standaard zie je
 * alleen de titel en de categorieën. Ga je erover met de muis, dan verschijnen
 * ook het aantal foto's en de datum.
 */
export function GalleryCard({ gallery, index, onOpen }: GalleryCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Lichte waas zodat de foto centraal blijft; bij hover donkerder voor leesbare tekst */}
      ...
      {/* Aantal foto's, rechtsboven, verschijnt bij hover */}
      ...
      {/* Titel linksboven, altijd zichtbaar */}
      ...
      {/* Onderaan: categorieën links (altijd zichtbaar), datum rechts (bij hover) */}
