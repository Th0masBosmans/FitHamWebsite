...
/**
 * De aftelklok naar het eerstvolgende evenement, op de homepagina. Telt elke
 * seconde af. Staat er niets meer op de kalender, dan toont dit blok niets.
 */
export function NextEventCountdown() {
  ...
  useEffect(() => {
    eventRepository.fetchEvents().then((events) => {
      // De evenementen komen al op datum gesorteerd binnen, dus het eerste dat nog
      // moet komen is meteen het eerstvolgende.
  ...
  return (
    ...
    >
      ...
      {/* Brede kaart: foto links, aftelklok en tekst rechts */}
      <Link
        href="/events"
      ...
      >
        {/* Decoratieve bollen, zelfde stijl als de webshopkaart */}
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center p-4 lg:p-6 gap-4 lg:gap-8">
          {/* Links: de foto in een kader, met titel, datum en plaats */}
          ...
          {/* Rechts: de aftelklok en de omschrijving */}
          <div className="lg:w-3/5 flex flex-col items-center justify-center gap-4 lg:gap-6 text-center p-5 lg:p-8">
            ...
            {/* Ziet eruit als een knop, maar is het niet: de hele kaart is al een link */}
